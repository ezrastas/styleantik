...
<div class="tabbable">
    <ul class="nav nav-pills">
		<li class="active"><a href="#tab1" data-toggle="tab"><?php echo JText::_( 'COM_ZHYANDEXMAP_MAPMARKER_DETAIL' ); ?></a></li>
		<li><a href="#tab2" data-toggle="tab"><?php echo JText::_('COM_ZHYANDEXMAP_MAPMARKER_DETAIL_APPEARANCE'); ?></a></li>
		<li><a href="#tab3" data-toggle="tab"><?php echo JText::_('COM_ZHYANDEXMAP_MAPMARKER_DETAIL_INTEGRATION'); ?></a></li>
		<li><a href="#tab4" data-toggle="tab"><?php echo JText::_('COM_ZHYANDEXMAP_MAPMARKER_DETAIL_ATTRIBUTES'); ?></a></li>
		<?php
						...
						else if ($field->id == 'jform_preseticontype')
						{
							...
							<?php 
								...
								echo '<div class="clr"></div>';
                                                                if ($mapVersion == "2.0")
                                                                {
                                                                    echo '<a class="btn btn-primary" href="http://api.yandex.ru/maps/doc/jsapi/2.0/ref/reference/option.presetStorage.xml" target="_blank">'.JText::_( 'COM_ZHYANDEXMAP_MAP_TERMSOFUSE_STD_ICONS' ).' <img src="'.$utilspath.'info.png" alt="'.JText::_( 'COM_ZHYANDEXMAP_MAP_TERMSOFUSE_STD_ICONS' ).'" style="margin: 0;" /></a>';                                                                  
                                                                }
                                                                else if ($mapVersion == "2.1")
                                                                {
                                                                    echo '<a class="btn btn-primary" href="http://api.yandex.ru/maps/doc/jsapi/2.1/ref/reference/option.presetStorage.xml" target="_blank">'.JText::_( 'COM_ZHYANDEXMAP_MAP_TERMSOFUSE_STD_ICONS' ).' <img src="'.$utilspath.'info.png" alt="'.JText::_( 'COM_ZHYANDEXMAP_MAP_TERMSOFUSE_STD_ICONS' ).'" style="margin: 0;" /></a>';                                                                  
                                                                }
                                                                else
                                                                {
                                                                    echo '<a class="btn btn-primary" href="http://api.yandex.ru/maps/doc/jsapi/2.x/ref/reference/option.presetStorage.xml" target="_blank">'.JText::_( 'COM_ZHYANDEXMAP_MAP_TERMSOFUSE_STD_ICONS' ).' <img src="'.$utilspath.'info.png" alt="'.JText::_( 'COM_ZHYANDEXMAP_MAP_TERMSOFUSE_STD_ICONS' ).'" style="margin: 0;" /></a>';                                                                  
                                                                }
