...
<div class="productdetails-view productdetails">
	...
	<div class="back-to-category">
    	<a href="<?php echo $catURL ?>" class="btn product-details" title="<?php echo $categoryName ?>"><span><?php echo vmText::sprintf('COM_VIRTUEMART_CATEGORY_BACK_TO',$categoryName) ?></span></a>
	</div>
