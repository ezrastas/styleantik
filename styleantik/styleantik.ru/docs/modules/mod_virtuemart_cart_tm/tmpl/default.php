...
if(!empty($match)) $data->billTotal = $match[1]; ?>
	...
	<div class="total_products"><a class="<?php if(!count($data->products)) echo ' disabled'; ?>" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=cart'); ?>" rel="nofollow"><?php echo vmText::sprintf('TPL_CART', $data->totalProduct); ?></a></div>
