...
VmConfig::loadConfig();
VmConfig::loadJLang('mod_virtuemart_product_tm', true);
...
$autoplayTimeout = $params->get( 'autoplayTimeout', 12000 );
$nav = $params->get( 'nav', true );
$responsDesktop = $params->get( 'responsDesktop', 4 );
$responsTablet = $params->get( 'responsTablet', 3 );
$responsPhone = $params->get( 'responsPhone', 2 );
$responsPhone2 = $params->get( 'responsPhone2', 1 );
...
if($cache){
	...
	$cache	= JFactory::getCache('mod_virtuemart_product_tm', 'output');
	$cache->setCaching(1);
...
/* Load tmpl default */
require(JModuleHelper::getLayoutPath('mod_virtuemart_product_tm',$params->get('layout', 'default')));
$output = ob_get_clean();
echo $output;
