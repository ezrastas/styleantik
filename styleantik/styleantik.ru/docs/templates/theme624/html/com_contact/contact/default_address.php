...
<div class="contact_details">
    ...
    <?php endif; ?>
        ...
        <div class="contact_details_telephone_wr">
            <?php
            ...
            if ($this->contact->fax && $this->params->get('show_fax')) : ?>
                <div class="fax">
                    ...
                    <?php echo '<' . $template->params->get('categoryItemHeading', 'h4') . '>' . JText::_('TPL_CONTACT_FAX') . '</' . $template->params->get('categoryItemHeading', 'h4') . '>'; ?>
    ...
    <?php if ($this->contact->mobile && $this->params->get('show_mobile')) :?>
        <div>
            ...
            <?php echo '<' . $template->params->get('categoryItemHeading', 'h4') . '>' . JText::_('TPL_CONTACT_MOBILE') . '</' . $template->params->get('categoryItemHeading', 'h4') . '>';?>
                </div>
    ...
    if ($this->contact->webpage && $this->params->get('show_webpage')) : ?>
        <div>
            ...
            <?php echo '<' . $template->params->get('categoryItemHeading', 'h4') . '>' . JText::_('TPL_CONTACT_WEBPAGE') . '</' . $template->params->get('categoryItemHeading', 'h4') . '>'; ?>
                </div>
            <div class="contact_details_webpage">
                <a href="<?php echo $this->contact->webpage; ?>"
                   target="_blank"><?php echo $this->contact->webpage; ?></a>
            </div>
