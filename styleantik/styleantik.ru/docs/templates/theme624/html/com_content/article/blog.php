...
?>
<article class="page-item page-item__blog page-item__<?php echo $this->pageclass_sfx ?>" itemscope
            ...
            <dl class="item_info_dl">
                ...
                if ($params->get('show_publish_date')) : ?>
                    <dd>
                        ...
                        <time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'Y-m-d H:i'); ?>"
                              class="item_published">
                            <?php echo JText::sprintf('TPL_ON', JHtml::_('date', $this->item->publish_up, JText::_('d.m.y'))); ?>
                        </time>
                    </dd>
                <?php endif;
                ...
                if ($info == 0):
                    if ($params->get('show_modify_date')) : ?>
                        <dd>
                            <time datetime="<?php echo JHtml::_('date', $this->item->modified, 'Y-m-d H:i'); ?>"
                                  class="item_modified">
                    ...
                    if ($params->get('show_create_date')) : ?>
                        <dd>
                            <time datetime="<?php echo JHtml::_('date', $this->item->created, 'Y-m-d H:i'); ?>"
                                  class="item_create">
