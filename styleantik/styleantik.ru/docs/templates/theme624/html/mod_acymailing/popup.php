...
<div class="title"><a href="#myModal" role="button" class="btn" data-toggle="modal"><?php echo JText::_('JLOGIN') ?></a></div>
...
<div class="modal-backdrop in" aria-hidden="true" data-dismiss="modal"></div>
  ...
  <div class="modal-header">
    ...
    <h3 id="myModalLabel"><?php echo JText::_('LOGIN_FORM') ?></h3>
  </div>
	...
	<div class="acymailing_fulldiv" id="acymailing_fulldiv_<?php echo $formName; ?>" <?php echo $styleString; ?> >
		...
		<div class="acymailing_module_form" >
			...
			<div class="acymailing_form">
					<?php print_r($listContent); foreach($fieldsToDisplay as $oneField){
