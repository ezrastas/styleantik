...
if ($this->category->category_name && empty($this->search)) 
{ ?>
	<h1 class="browse-view"><span><span><?php echo $this->category->category_name; ?></span></span></h1>
	
<?php } ?>
<?php if (empty($this->search) && ($this->category->category_description || $this->baseurl.'/'.$this->category->images[0]->file_url)) { ?>
<div class="wrap-cat">
