...
if($viewData['orderable']) {
	echo '<button type="submit" name="addtocart" class="addtocart-button btn" value="'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'" title="'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'">'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'</button>';
} else {
