...
<div class="controls">
        <div class="input-prepend">
            <span class="add-on">
              <span class="fa fa-user hasTooltip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"></span>
            </span>
...
<?php  } else if ($user->id){ ?>
    ...
    <button type="submit" name="Submit" class="btn button" value="<?php echo vmText::_( 'COM_VIRTUEMART_BUTTON_LOGOUT'); ?>"><i class="fa fa-sign-in"></i> <?php echo vmText::_( 'COM_VIRTUEMART_BUTTON_LOGOUT'); ?></button>
