...
<!-- Comment Title -->
<?php echo '<'. $template->params->get('itemBlogItemHeading') .' class="komento_title heading-style-4">'; ?><?php echo JText::_( 'COM_KOMENTO_COMMENTS' ); ?><?php echo '</'. $template->params->get('itemBlogItemHeading') .'>'; ?>
