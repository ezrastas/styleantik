...
<div id="wrapper">
    <div id="header">
           <div id="mambo"><img src="templates/mambo_admin/images/mambo.gif" alt="Логотип Mambo" /></div>
    </div>
</div>
...
<table width="100%" class="menuline" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <td class="menubackgr" align="right"><a href="index2.php?option=logout" style="color: #FF9E31; font-weight: bold">Выход</a> <strong><?php echo $my->username;?></strong>&nbsp;</td>
    </tr>
</table>
<?php } ?>
