...
* Mambo - свободное программное обеспечение. 
...
<head>
<title><?php echo $mosConfig_sitename; ?> - Панель управления Mambo</title>
...
<div id="wrapper">
    <div id="header">
           <div id="mambo"><img src="templates/mambo_admin_blue/images/header_text.png" alt="Логотип Mambo" /></div>
    </div>
</div>
...
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <td class="menubackgr" align="right"><a href="index2.php?option=logout" style="color: #333333; font-weight: bold">Выход</a> <strong><?php echo $my->username;?></strong>&nbsp;</td>
    </tr>
</table>
<?php } ?>
<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
