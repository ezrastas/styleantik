...
<head>
   ...
   <style type="text/css">
   @import url(templates/joomla_admin_lsy/css/admin_login.css);
   </style>
   ...
   <div id="ctr" align="center">
      <div class="login">
         <div class="login-form">
            <img src="templates/joomla_admin_lsy/images/login.gif" alt="Login" />
            <form action="index.php" method="post" name="loginForm" id="loginForm">
               <div class="form-block">
                  ...
                  <div>
                     <input name="usrname" type="text" class="inputbox" size="15" />
                  </div>
                  <div class="inputlabel">
                     Password
                  </div>
         ...
         <div class="login-text">
            <div class="ctr">
               <img src="templates/joomla_admin_lsy/images/security.png" width="64" height="64" alt="security" />
            </div>
            <p>
            Welcome to Joomla!
            </p>
