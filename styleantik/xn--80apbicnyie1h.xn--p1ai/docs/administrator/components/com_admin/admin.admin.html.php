...
class HTML_admin_misc {
	...
	*/
	...
	function system_info( $version ) {
		...
		?>
			...
			<tr>
				...
				<td>
					...
					<tr>
						<td width="250">
							Эмуляция Joomla! Register Globals:
						</td>
		...
		<?php
		$tabs->endTab();
		$tabs->startTab('Разрешения','perms');
		?>
			<table class="adminform">
			<tr>
				<th colspan="2">
			...
			<tr>
				<td>
					<strong>Для работы ВСЕХ функций и возможностей Joomla, ВСЕ указанные ниже каталоги должны быть доступны для записи:</strong><br />   <br />
					<?php
