<html>
<head>
<title>MamboV45104dev :: Администрирование [Mambo Open Source]</title>
<style type="text/css">
...
<table cellpadding="4" cellspacing="0" class="adminlist">
  <tr>
    <td colspan="3">Вы можете скопировать и вставить {mos_sb_discuss:##} для категории, которую Вы хотите использовать!    </td>
  </tr>
       <tr>
   <th><b>SB идентификатор категории<b /></th>
   <th><b>SB mosbot код<b /></th>
   <th><b>SB Категории<b /></th>
      </tr>
<?php
   $k = 0;
   foreach ($rows as $row){
...
<input type="Button" name="Close" value="Закрыть" onClick="self.close();">
</td></tr>          
</table> 
</body>
</html>
