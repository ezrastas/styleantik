	...
	<table class="adminform">
		...
		<tr>
			...
			<td><?php
				...
				echo ' />';
				echo '<label for="use_price_access"><strong>Включить эту функцию</strong></label><br />';
...
<?php
  ...
  $tabs->startTab( $spacer . $VM_LANG->_PHPSHOP_ADMIN_CFG_SITE . $spacer, "site-page");
    ...
    $subtabs2->startTab( "Отображение элементов", "layout-1-page");
?>
...
<?php
    $subtabs2->endTab();
    $subtabs2->startTab( "Настройки отображения", "layout-2-page");
?>
<table class="adminform">
    <tr>
