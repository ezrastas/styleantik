...
$tabs->startTab( "Основные", "global-page");
?>
<table class="adminform">
    ...
    <tr>
      <td width="31%" align="right">
          Класс реализующий оплату, (например <strong>ps_netbanx</strong>) :<br />
          default: ps_payment<br />
          <i>Оставьте пустым, если не знаете что это!</i>
      </td>
...
<?php echo mm_ToolTip("Показывается на странице подтверждения заказя. Может быть: Код HTML формы, который предоставлен вашим платежным процессором, Подсказки для покупателя и т.д.") ?>
<br />
