...
*
* http://virtuemart.net
* Федоринов Григорий aka Skynet80 http://virtuemart.ru
*/
...
<br />
<?php
$title = '<img src="'. IMAGEURL .'ps_image/product_code.png" border="0" align="center" alt="Товар" />&nbsp;&nbsp;';
$title .= $action;
...
$tabs->startTab( "<img src=\"". IMAGEURL ."ps_image/edit.png\" align=\"center\" width=\"16\" height=\"16\" border=\"0\" />&nbsp;$info_label", "Информация");
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="2" class="adminform">
    ...
    <tr>
      ...
      <br /><br />
        ...
        &nbsp;&nbsp;&nbsp;
        <img src="<?php echo $db->f("product_availability") ? IMAGEURL."availability/".$db->sf("product_availability") : IMAGEURL.NO_IMAGE; ?>" name="imagelib" border="0" alt="Предпросмотр" />
      </td>
    <tr> 
      <td width="21%" ><div style="text-align:right;font-weight:bold;">
...
$tabs->endTab();
$tabs->startTab( "<img src=\"". IMAGEURL ."ps_image/info.png\" width=\"16\" height=\"16\" align=\"center\" border=\"0\" alt=\"Информация\" />&nbsp;$dim_weight_label", "О товаре");
...
<?php
$tabs->endTab();
$tabs->startTab( "<img src=\"". IMAGEURL ."ps_image/image.png\" width=\"16\" height=\"16\" align=\"center\" border=\"0\" />&nbsp;$images_label", "Изображения товара");
...
<?php
$tabs->endTab();
$tabs->startTab( "<img src=\"". IMAGEURL ."ps_image/related.png\" width=\"16\" height=\"16\" align=\"center\" border=\"0\" />&nbsp;".$VM_LANG->_PHPSHOP_RELATED_PRODUCTS, "Сопутствующие товары");
?>
	<table class="adminform">
		<tr>
...
if( $clone_product == "1" ) {
	...
	if( $db->num_rows() > 0 ) {
		echo "<h3>Позиции уже были скопированы:</h3>";
	}
