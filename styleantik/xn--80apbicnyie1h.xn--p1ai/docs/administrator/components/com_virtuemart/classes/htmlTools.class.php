...
*/
function mm_ToolTip( $tooltip, $title='Совет!', $image = "{mosConfig_live_site}/images/M_images/con_info.png", $width='', $text='', $href='#', $link=false ) {
...
function mm_showMyFileName( $filename ) {
    ...
    if (DEBUG == '1' ) {
        echo mm_ToolTip( '<div class=\'inputbox\'>Начало файла: '. $filename.'</div>');
    }
}
/**
