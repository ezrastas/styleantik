...
class vmMenuBar extends mosMenuBar {
	...
	*/
	function addNew( $task='new', $page, $alt='Новый', $formName="adminForm" ) {
		global $vmIcons;
	...
	* @param string An override for the alt text
	*/
	function publishList( $func, $task='publish', $alt='Публиковать' ) {
		global $vmIcons;
		@$bar =& JToolBar::getInstance('toolbar');
	...
	* @param string An override for the alt text
	*/
	function unpublishList( $func, $task='unpublish', $alt='Скрыть' ) {
		global $vmIcons;
		@$bar =& JToolBar::getInstance('toolbar');
	...
	* @param string An override for the alt text
	*/
	function deleteList( $func, $task='remove', $alt='Удалить' ) {
		global $vmIcons;
		@$bar =& JToolBar::getInstance('toolbar');
	...
	* @param string An override for the alt text
	*/
	function cancel( $task='cancel', $alt='Отменить' ) {
		global $page, $vmIcons;
		@$bar =& JToolBar::getInstance('toolbar');
