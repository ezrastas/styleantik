	...
	function show( &$rows, $section, $section_name, &$pageNav, &$lists, $type ) {
		...
		<tr>
			...
			if ( $section == 'content') {
				?>
				<th class="categories">
				Управление категориями <small><small>[ Всё содержимое ]</small></small>
				</th>
				<td width="right">
				...
				?>
				<th class="categories">
				Управление категориями <small><small>[ <?php echo $section_name;?> ]</small></small>
				</th>
				<?php
			}
			?>
	...
	function edit( &$row, &$lists, $redirect, $menus ) {
		...
		<tr>
			...
			?>
				...
				<tr>
					<td colspan="2">
					Будет создан новый пункт в выбранном вами меню
					<br /><br />
					</td>
				<tr>
				<tr>
