...
$cryptheight = 17;   // Hauteur du cryptogramme (en pixels)
...
$charR = 125;     // Couleur des caractères au format RGB: Red (0->255)
$charG = 125;     // Couleur des caractères au format RGB: Green (0->255)
$charB = 125;     // Couleur des caractères au format RGB: Blue (0->255)
...
$cryptusemax = 500;  // Nb maximum de fois que l'utilisateur peut générer le cryptogramme
