...
*/
function mosWarning($warning, $title='Предупреждение Joomla!') {
        global $mosConfig_live_site;
...
class mosCommonHTML {
        ...
        function ContentLegend( ) {
                ...
                <tr align="center">
                        <td>
                        <img src="images/publish_y.png" width="12" height="12" border="0" alt="Ожидает публикации" />
                        </td>
                        <td>
                        Опубликовано, но <u>Не активно</u> |
                        </td>
                        <td>
                        <img src="images/publish_g.png" width="12" height="12" border="0" alt="На сайте" />
                        </td>
                        <td>
                        Опубликовано и <u>Активно</u> |
                        </td>
                        <td>
                        <img src="images/publish_r.png" width="12" height="12" border="0" alt="Истек срок публикации" />
                        </td>
                        <td>
                        Опубликовано, но <u>Истек срок публикации</u> |
                        </td>
                        <td>
                        <img src="images/publish_x.png" width="12" height="12" border="0" alt="Истек срок публикации" />
                        </td>
                        <td>
                        Не опубликовано
                        </td>
                ...
                <tr>
                        ...
                        Нажмите на значок для переключения состояния объекта.
                        </td>
                </tr>
                </table>
                <?php
