...
<meta name="Generator" content="Система управления содержимым Joomla!" />
...
<tr>
	...
	<td class="menubackgr" align="right">
		<div id="wrapper1">
		<div><a href="<?php echo $mosConfig_live_site; ?>/index.php" target="_blank" title="Предпросмотр сайта"><img src="../includes/js/ThemeOffice/preview.png" border="0" align="middle" /></a></div>
...
<?php
/*
<div align="center" class="smallgrey"><b>Хостинг от RU-CENTER</b> 
  <br/>
  <a href="http://hosting.nic.ru" target="_blank">RU-CENTER > Надежный хостинг от надежной компании</a> | <a href="www.mail.nic.ru" target="_blank" alt="Заведите собственную почту от RU-CENTER">Заведите собственную почту от RU-CENTER</a>
</div>
			<div align="center">
			...
			<div align="center" class="smallgrey">
				<?php echo $version; ?>
				<br/>
				<a href="http://joom.ru/" target="_blank">Проверить последнюю версию Joomla! RE</a> | <a href="http://www.joomla.org/latest10" target="_blank">Проверить последнюю версию Joomla!</a>
			</div>
			<?php
			if ( $mosConfig_debug ) {
