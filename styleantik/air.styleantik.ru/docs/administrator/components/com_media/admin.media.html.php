...
class HTML_Media {
					...
					<tr>
						<td>
							...
							<tr>
								...
								<td align="right">
									Загрузить файл <small>[ Макс. размер = <?php echo ini_get( 'post_max_size' );?> ]</small>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td>
				<div align="center" style="font-size:small;font-weight:bold;color:#CC0000;font-family: Helvetica, sans-serif;">
					Проблема конфигурации: &quot;<?php echo $BASE_DIR.$BASE_ROOT; ?>&quot; не существует.
				</div>
			</td>
		</tr>
		</table>
	...
	function show_image($img, $file, $info, $size, $listdir) {
		...
		$overlib .= '</tr>';
		$overlib .= '</table>';
		$overlib .= '<br/> *Нажмите для увеличения*';
		$overlib .= '<br/> *Нажмите для получения html-кода изображения*';
		?>
		<div style="float:left; padding: 5px">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					<a href="index2.php?option=com_media&amp;task=delete&amp;delFile=<?php echo $file; ?>&amp;listdir=<?php echo $listdir; ?>" target="_top" onclick="return deleteImage('<?php echo $file; ?>');" title="Удалить">
						<img src="components/com_media/images/edit_trash.gif" width="15" height="15" border="0" alt="Удалить" /></a>
					<a href="#" onclick="javascript:window.top.document.forms[0].imagecode.value = '<img src=&quot;<?php echo $img_url_link;?>&quot; align=&quot;left&quot; hspace=&quot;6&quot; alt=&quot;Image&quot; />';" title="Код изображения">
						<img src="components/com_media/images/edit_pencil.gif" width="15" height="15" border="0" alt="HTML-код" /></a>
				</div>					
			</div>
		</div>
		<?php
	...
	function show_dir( $path, $dir, $listdir ) {
		...
		$overlib .= '</tr>';
		$overlib .= '</table>';
		$overlib .= '<br/> *Нажмите для открытия**';
		?>
		<div style="float:left; padding: 5px">
	...
	function show_doc($doc, $size, $listdir, $icon) {
		...
		$overlib = 'Размер файла: '. $size;
		$overlib .= '<br/><br/> *Нажмите для получения url*';
		?>
		<div style="float:left; padding: 5px">
			<div class="imgTotal" onmouseover="return overlib( '<?php echo $overlib; ?>', CAPTION, '<?php echo $doc; ?>', BELOW, RIGHT, WIDTH, 200 );" onmouseout="return nd();">
				<div align="center" class="imgBorder">
				  <a href="index3.php?option=com_media&amp;task=list&amp;listdir=<?php echo $listdir; ?>" onclick="javascript:window.top.document.forms[0].imagecode.value = '<a href=&quot;<?php echo $doc_url_link;?>&quot;>Вставьте сюда свой текст</a>';">
	...
	function imageStyle($listdir) {
		...
		function deleteFolder(folder, numFiles) {
			if(numFiles > 0) {
				alert("В папке \""+folder+"\" содержится "+numFiles+" файлов/папок.\n\nПожалуйста, сначала удалите из папки \""+folder+"\" все содержимое.");
				return false;
			}
