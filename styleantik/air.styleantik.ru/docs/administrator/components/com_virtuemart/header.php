...
if (!defined('_PSHOP_ADMIN')) {
  ...
  if( stristr( $_SERVER['PHP_SELF'], "index2.php" )) {
    ...
    <a href="index.php" title="Назад"><h3>&nbsp;&nbsp;&gt;&gt; '.$VM_LANG->_PHPSHOP_BACK_TO_MAIN_SITE.' &lt;&lt;</h3></a>';
  }
  // Проверяем шаблон для админ части
...
// Для того чтобы показывать спецзнаки мы делаем буфферизацию вывода интерпритатора
ob_start();

for ($i=0;$i < sizeof($mod);$i++) {  // Рекурсивно по всем модулям
             ...
             switch($mod[$i]) {
                ...
                case "store":
                    ...
                    [null,'<?php echo $lbl ?>',null,null,'<?php echo $lbl ?>',
                        ...
                        _cmSplit,
                        ['<img src="<?php echo $my_path ?>content.png" />','Список модулей доставки','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=store.shipping_modules") ?>',null,'Список модулей доставки'],
                        _cmSplit,
                ...
                case "help":
                    ...
                    [null,'<?php echo $lbl ?>',null,null,'<?php echo $lbl ?>',
                        ['<img src="<?php echo $my_path ?>document.png" />','О Virtuemart','<?php $sess->purl($_SERVER['PHP_SELF']."?pshop_mode=admin&page=help.about") ?>',null,'ВМРЕ'],
                        ['<img src="<?php echo $my_path ?>help.png" />','База Знаний  ВМРЕ','http://wiki.virtuemart.ru/','_blank','База Знаний  ВМРЕ'],
                        ['<img src="<?php echo $my_path ?>help.png" />','Демо сайт ВМРЕ','http://demo.virtuemart.ru/','_blank','База Знаний  ВМРЕ'],
                        ['<img src="<?php echo $my_path ?>language.png" />','Форум Сообщества  ВМРЕ ','http://forum.virtuemart.ru/','_blank','Форум Сообщества  ВМРЕ']
                        <?php break;
...
// Очищаем буфер
ob_end_clean();
// конвертируем все спецзнаки в HTML последовательности
$menu_code = htmlspecialchars( $menu_code, ENT_NOQUOTES,'windows-1251' );
// теги возвращаем на место 
...
<img align="left" hspace="15" src="<?php echo IMAGEURL ?>ps_image/menu_logo.gif" alt="Логотип ВМРЕ"  title="Логотип ВМРЕ"/>
<br/><div id="vmMenuID" style="border: 1px solid black;text-align:left;background:#BCD1DD;" height="52" ></div>
<br />
