...
)  COMMENT='Используется для хранения записей о партнерке';
...
INSERT INTO `#__vm_country` VALUES (1, 1, 'Афганистан', 'AFG', 'AF'),
(2, 1, 'Албания', 'ALB', 'AL'),
(3, 1, 'Алжир', 'DZA', 'DZ'),
...
)  COMMENT='Для хранения типов кредитных карт';
...
)  COMMENT='Зарегистрированные функции';
...
(18, 'coupon', 'Управление дисконтом', 'admin,storeadmin', 'Y', 11);
...
)  COMMENT='Хранит все действия и изменния которые произошли с заказом';
...
)  COMMENT='Хранит все позиции которые являются частью заказа';
...
)  COMMENT='Способы оплаты которые были выбраны для заказа';
...
)  COMMENT='Все доступные способы заказа';

## 
## Dumping data for table `#__vm_order_status`
## 

INSERT INTO `#__vm_order_status` VALUES (1, 'P', 'Ожидание', 1, 1),
...
)  COMMENT='Хранит информацию ОплатитьВ и ДоставитьВ во время заказа';
...
)  COMMENT='Используется для хранения заказов';
...
)  COMMENT='Методы оплаты для вашего магазина';
...
)  COMMENT='Все товары хранятся здесь';
...
)  COMMENT='Хранятся свойства  и их значения для позиций';
...
)  COMMENT='Атрибуты для родительских товаров используются позициями';
...
)  COMMENT='Дисконтные скидки, которые могут быть назначены товару';
...
)  COMMENT='Активные скачивания для скачиваемых товаров';
...
CREATE TABLE IF NOT EXISTS `#__vm_product_files` (
  ...
  PRIMARY KEY  (`file_id`)
)  COMMENT='Дополнительные изображения и файлы к товару';
...
)  COMMENT='Несущие доставки для стандартного модуля доставки';
...
)  COMMENT='Ставки доставки для стандартного модуля доставки';
...
)  COMMENT='Группы клиентов';

## 
## Dumping data for table `#__vm_shopper_group`
## 

INSERT INTO `#__vm_shopper_group` VALUES (5, 1, '-по умолчанию-', 'Это стандартная группа клиентов.', 0.00, 1, 1),
...
,(166, 176, 'Республика Адыгея', '001','01');
,(167, 176, 'Республика Башкортостан', '002','02')
,(168, 176, 'Республика Бурятия', '003','03')
,(169, 176, 'Республика Алтай', '004','04')
,(170, 176, 'Республика Дагестан', '005','05')
,(171, 176, 'Республика Ингушетия', '006','06')
,(172, 176, 'Кабардино-Балкарская Республика', '007','07')
,(173, 176, 'Республика Калмыкия', '008','08')
,(174, 176, 'Карачаево-Черкесская Республика', '009','09')
,(175, 176, 'Республика Карелия', '010','10')
,(176, 176, 'Республика Коми', '011','11')
,(177, 176, 'Республика Марий Эл', '012','12')
,(178, 176, 'Республика Мордовия', '013','13')
,(179, 176, 'Республика Саха (Якутия)', '014','14')
,(180, 176, 'Республика Северная Осетия (Алания)', '015','15')
,(181, 176, 'Республика Татарстан', '016','16')
,(182, 176, 'Республика Тыва (Тува)', '017','17')
,(183, 176, 'Удмуртская Республика', '018','18')
,(184, 176, 'Республика Хакасия', '019','19')
,(185, 176, 'Чеченская Республика', '020,95','20,95')
,(186, 176, 'Чувашская Республика', '021','21')
,(187, 176, 'Алтайский край', '022','22')
,(188, 176, 'Краснодарский край', '023','23')
,(189, 176, 'Красноярский край', '024','24')
,(190, 176, 'Приморский край', '025','25')
,(191, 176, 'Ставропольский край', '026','26')
,(192, 176, 'Хабаровский край', '027','27')
,(193, 176, 'Амурская область', '028','28')
,(194, 176, 'Архангельская область', '029','29')
,(195, 176, 'Астраханская область', '030','30')
,(196, 176, 'Белгородская область', '031','31')
,(197, 176, 'Брянская область', '032','32')
,(198, 176, 'Владимирская область', '033','33')
,(199, 176, 'Волгоградская область', '034','34')
,(200, 176, 'Вологодская область', '035','35')
,(201, 176, 'Воронежская область', '036','36')
,(202, 176, 'Ивановская область', '037','37')
,(203, 176, 'Иркутская область', '038','38')
,(204, 176, 'Калининградская область', '039','39')
,(205, 176, 'Калужская область', '040','40')
,(206, 176, 'Камчатская область', '041','41')
,(207, 176, 'Кемеровская область', '042','42')
,(208, 176, 'Кировская область', '043','43')
,(209, 176, 'Костромская область', '044','44')
,(210, 176, 'Курганская область', '045','45')
,(211, 176, 'Курская область', '046','46')
,(212, 176, 'Ленинградская область', '047','47')
,(213, 176, 'Липецкая область', '048','48')
,(214, 176, 'Магаданская область', '049','49')
,(215, 176, 'Московская область', '050','50')
,(216, 176, 'Мурманская область', '051','51')
,(217, 176, 'Нижегородская область', '052','52')
,(218, 176, 'Новгородская область', '053','53')
,(219, 176, 'Новосибирская область', '054','54')
,(220, 176, 'Омская область', '055','55')
,(221, 176, 'Оренбургская область', '056','56')
,(222, 176, 'Орловская область', '057','57')
,(223, 176, 'Пензенская область', '058','58')
,(224, 176, 'Пермская область', '059','59')
,(225, 176, 'Псковская область', '060','60')
,(226, 176, 'Ростовская область', '061','61')
,(227, 176, 'Рязанская область', '062','62')
,(228, 176, 'Самарская область', '063','63')
,(229, 176, 'Саратовская область', '064','64')
,(230, 176, 'Сахалинская область', '065','65')
,(231, 176, 'Свердловская область', '066','66')
,(232, 176, 'Смоленская область', '067','67')
,(233, 176, 'Тамбовская область', '068','68')
,(234, 176, 'Тверская область', '069','69')
,(235, 176, 'Томская область', '070','70')
,(236, 176, 'Тульская область', '071','71')
,(237, 176, 'Тюменская область', '072','72')
,(238, 176, 'Ульяновская область', '073','73')
,(239, 176, 'Челябинская область', '074','74')
,(240, 176, 'Читинская область', '075','75')
,(241, 176, 'Ярославская область', '076','76')
,(242, 176, 'Москва', '077','77')
,(243, 176, 'Санкт-Петербург', '078','78')
,(244, 176, 'Еврейская автономная область', '079','79')
,(245, 176, 'Агинский Бурятский автономный округ', '080','80')
,(246, 176, 'Коми-Пермяцкий автономный округ', '081','81')
,(247, 176, 'Корякский автономный округ', '082','82')
,(248, 176, 'Ненецкий автономный округ', '083','83')
,(249, 176, 'Таймырский (Долгано–Ненецкий) автономный округ', '084','84')
,(250, 176, 'Усть-Ордынский Бурятский автономный округ', '085','85')
,(251, 176, 'Ханты-Мансийский автономный округ', '086','86')
,(252, 176, 'Чукотский автономный округ', '087','87')
,(253, 176, 'Эвенкский автономный округ', '088','88')
(254, 176, 'Ямало-Ненецкий автономный округ', '089','89')
;
...
INSERT INTO `#__vm_tax_rate` VALUES (3, 1, 'МСК', 'Российская Федерация', 4556755, 0.0825);
...
)  COMMENT='Информация о клиенте BT = ОплатитьВ и ST = ДоставитьВ';
...
## 
INSERT INTO `#__vm_vendor` VALUES (1, '3456.ru', 'Ковалёв', 'Владимир', 'Анатольевич', 'Администратор', '8-926-223-49-05', '8-926-223-49-05', '8-926-223-49-05', 'wov2004@gmail.com', '8-926-223-49-05', '', '', 'Люберцы', ' -', 'RUS', '140007', '3456.ru', '', 0, '', '571b702f930ee4991aa634086a13c293.jpg', 'Rus', 950302468, 1162379357, 'shop_image/', '', 'http://3456.ru', 0.00, 0.00, '1|руб\0|0|,| |1|8'),
...
)  COMMENT='Категории продавцов';

## 
## Dumping data for table `#__vm_vendor_category`
## 

INSERT INTO `#__vm_vendor_category` VALUES (6, '-по умолчанию-', 'Стандартная');
...
CREATE TABLE IF NOT EXISTS `#__vm_zone_shipping` (
  ...
  PRIMARY KEY  (`zone_id`),
  KEY `zone_id` (`zone_id`)
)  COMMENT='Зоны для  Модуля доставки по зонам';
