		...
		<tr> 
		  <td colspan="2"> 
			<table  class="adminlist">
			  ...
			  ?>
			  <tr bgcolor="<?php echo $bgcolor; ?>" valign="top" align="center"> 
				...
				<td width="12%"><?php 
					...
					?></td>
				<td width="12%"><?php echo $CURRENCY_DISPLAY->getFullValue($dbt->f("product_final_price"));  ?></td>
				<td width="19%"><?php echo $CURRENCY_DISPLAY->getFullValue($t); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			  </tr>
			  <?php 
			  } 
			  ?> 
