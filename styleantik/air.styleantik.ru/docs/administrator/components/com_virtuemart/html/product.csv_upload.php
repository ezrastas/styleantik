...
<table class="adminform" border="0">
	...
	<tr>
		...
		align="center" /><?php echo $VM_LANG->_PHPSHOP_CSV_SUBMIT_EXPORT ?></a>
...
<?php
$tabs->endTab();
//skynet80 hack rusxml
$tabs->startTab('Работа с XML','rusxml');
?>
<div>
<br /><br />
		
			<h1 style="color:red;">Выгрузка товаров в XML формата ЯНДЕКС-МАРКЕТ</h1>
	<a href="#"
			onclick="javascript: document.adminForm.func.value='export_yml'; document.adminForm.no_html.value='1';submitbutton();document.adminForm.func.value='product_csv';">
		<img alt="Экспорт" border="0" src="<?php echo $mosConfig_live_site ?>/administrator/images/backup.png"
		align="center" /><?php echo $VM_LANG->_PHPSHOP_RUSXML_SUBMIT_EXPORTYML ?></a>
</div>		
<?php
$tabs->endPane();
?>
