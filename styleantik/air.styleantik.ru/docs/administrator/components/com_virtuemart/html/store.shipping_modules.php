...
$ps_shipping_method = new ps_shipping_method;
 ...
 <table width="100%" cellspacing="0" cellpadding="4" border="0">
  <tr>
    ...
    <td><span class="sectionname">Список модулей доставки</span></td>
  </tr>
</table>
...
?>
  <table width="100%" class="adminlist">
    <tr> 
      ...
      <th class="title">Версия</th>
      <th class="title">Автор</th>
      <th class="title">Сайт автора</th>
      <th class="title">Email автора</th>
      <th>Описание</th>
    </tr>
<?php
    $i = 0;
      ...
      <tr bgcolor="<?php echo $bgcolor ?>"> 
        ...
        <td><?php 
          if( in_array(str_replace('.php', '', $row['filename']), $PSHOP_SHIPPING_MODULES ) )
            echo "<img src=\"$mosConfig_live_site/administrator/images/tick.png\" border=\"0\" alt=\"Активен\"  align=\"center\"/>";
        ?></td>
        <td width="19%"><?php
        echo $row["name"];
        echo "<br/>"; 
