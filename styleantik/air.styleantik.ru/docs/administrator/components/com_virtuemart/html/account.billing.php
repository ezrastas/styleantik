...
/**
 * Эта секция будет изменяться в будущих релизах VirtueMart,
 * когда будет реализована регистрация для менеджеров
 */
$required_fields = Array( 'email', 'first_name', 'last_name', 'address_1', 'city', 'zip', 'country', 'phone_1' );

$shopper_fields = array();
// Это список всех полей формы
// Они распределены по отдельным наборам полей
// начало границы набора полей называется 
//  uniqid('fieldset_begin')
// и конец границы набора полей uniqid('fieldset_end')
...
<div style="width:90%;">
   ...
   /**
    * @deprecated 
    * спасибо  Zdenek за это. Проверка дополнительных полей
    */
   for( $i=1; $i<6; $i++ ) {
