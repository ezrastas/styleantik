...
/* setup the db and query */
 ...
 ?>
    ...
    if (!setlocale(LC_ALL, "ru_RU.CP1251")) setlocale(LC_ALL,"ru_RU");
    echo strftime("%b %e, %Y", $start_date)." --&gt; ". strftime("%b %e, %Y", $end_date); 
    ?></h4>
      ...
      <?php
        ...
        while ( $has_next) {
        	if( $dbpl->f("order_date") == $db->f("order_date")) {
	          ...
	          echo '<td align="center">' . $dbpl->f("product_name") . " (" . $dbpl->f("product_sku") . ")</td>\n";
