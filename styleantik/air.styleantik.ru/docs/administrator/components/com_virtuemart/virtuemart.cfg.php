...
define('PSHOP_OFFLINE_MESSAGE', '<h2>Наш магазин закрыт на учет.</h2> Пожалуйста посетите нас позже.');
...
define('VM_ONCHECKOUT_LEGALINFO_SHORTTEXT', '<h5>Политика возврата</h5>

Проданный товар обмену и возврату не подлежит. см. <a href="%s" onclick="%s" target="_blank">Политика возврата</a>.');
