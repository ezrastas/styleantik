...
//если оба модуля включены, то для каждого выделяется 50% области
	$usera = 'user1';
	$userb = 'user2';
} else if ((mosCountModules( 'user1' )) || (mosCountModules( 'user2' ))) { 
// если же один лишь модуль, то для него выделяется вся область, 100%
	$usera = 'user3';
	$userb = 'user3';
}
?>
...
<div id="pagewidth-800" >
	<div id="header" >
		...
		<div id="top-bottom">
			<a href="index.php">
				<?php echo '<img src="' .$mosConfig_live_site. '/templates/' .$GLOBALS['cur_template']. '/images/logo.gif" border="0" width="250" height="80" alt="логотип" />'; ?>
				</a>
		</div>
		<?php 
